...
import static com.max.homon.kit.netty.protocol.Command.HTTP_PROXY;
 ...
 * @author ohun@live.cn
 */
public final class HttpResponseMessage extends AbstractByteBufMessage {
    public int statusCode;
    public String reasonPhrase;
    public Map<String, String> headers = new HashMap<>();
    public byte[] body;

    public HttpResponseMessage(Packet message, IConnection connection) {
