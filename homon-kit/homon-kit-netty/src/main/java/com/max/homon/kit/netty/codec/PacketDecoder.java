...
package com.max.homon.kit.netty.codec;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.max.homon.kit.netty.protocol.JsonPacket;
import com.max.homon.kit.netty.protocol.Packet;
import com.max.homon.kit.netty.protocol.UDPPacket;
...
import static com.max.homon.kit.netty.protocol.Packet.decodePacket;
...
public final class PacketDecoder extends ByteToMessageDecoder {
    ...
    public static Packet decodeFrame(String frame) throws Exception {
        ...
        return JSONObject.parseObject(frame, JsonPacket.class);
    }
}