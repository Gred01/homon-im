 ...
 * @author ohun@live.cn
 */
public abstract class AbstractByteBufMessage extends AbstractBaseMessage {

    public AbstractByteBufMessage(Packet message, IConnection connection) {
    ...
    public void encodeString(ByteBuf body, String field) {
        encodeBytes(body, field == null ? null : field.getBytes(Common.UTF_8));
    }
    ...
    public String decodeString(ByteBuf body) {
        ...
        return new String(bytes, Common.UTF_8);
    }
